    ...
    return (
        <div>
            ...
            <div className="mt-10 container mx-auto space-y-10">
                <h2 className="text-2xl  text-center font-bold  text-blue-900 divider divider-warning ">Memories in Bloom with <span className="text-yellow-500">featured</span></h2>
                ...
                <div className="text-center divider divider-warning">
                    <button className='btn bg-[#b76e79] w-72 text-white btn-outline  '>Explore more</button>
                </div>
            </div>


            <div className="mt-20 space-y-10">
                <h2 className="text-2xl  text-center font-bold text-blue-900 ">Become a part of<span className="text-yellow-500"> Eventa.</span></h2>
                <Partner></Partner>
            </div>
